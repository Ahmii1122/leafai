  ...
  return (
    <section className="max-w-contained mx-auto mt-[214px]">
      <div className="text-center p-6">
        ...
        <p className="text-gray font-opensans font-normal text-[20px] mx-[30%] mt-2">
          Discover the power of intelligent search across your entire digital
          workspace.
        </p>
        <div className="mt-9 flex justify-center">
          <div className="bg-gray-200 p-1 border border-gray/30 rounded-full flex">
            <button
              className={`px-4 py-2 rounded-full transition ${
                billingCycle === "monthly"
                  ? "bg-white shadow border border-gray/30"
                  : "text-gray-600"
              }`}
        ...
        <div className="mt-[70px] grid md:grid-cols-3 gap-6">
          {pricingOptions[billingCycle].map((plan) => (
            <div
              key={plan.id}
